...
<object type="application/x-shockwave-flash" data="<?php echo '/uploads' . $md_banner->getSrc(); ?>" width="<?php echo $options['width']; ?>" height="<?php echo $options['height']; ?>" onmousedown="banner_navigate(<?php echo $md_banner->getNuevaVentana(); ?>)">
...
<script type="text/javascript">
  function banner_navigate(new_window){
    if(new_window){
